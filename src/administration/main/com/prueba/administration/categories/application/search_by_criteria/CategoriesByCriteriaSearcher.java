...
public class CategoriesByCriteriaSearcher implements Query {
    ...
    public CategoriesByCriteriaSearcher(List<HashMap<String, String>> filters, Optional<String> orderBy,
